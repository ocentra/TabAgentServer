...
mod tests {
    ...
    fn test_adaptive_concurrency_controller() {
        let mut controller = AdaptiveConcurrencyController::new();
        
        // Initially should be in traditional mode
        assert_eq!(controller.get_mode(), ConcurrencyMode::Traditional);
        
        // Set high load metrics to trigger switch to lock-free
        let metrics = ConcurrencyMetrics {
            operation_count: 15000, // Above lock-free threshold
        ...
        // Should switch to lock-free mode
    ...
    fn test_adaptive_vector_index() {
        ...
        // Should start in traditional mode
