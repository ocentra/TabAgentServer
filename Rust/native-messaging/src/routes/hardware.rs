//! Hardware Detection Routes for Native Messaging
//!
//! Routes for querying hardware capabilities via Chrome extension.
...
#[async_trait]
impl NativeMessagingRoute for GetHardwareInfoRoute {
...
crate::enforce_native_messaging_route!(GetHardwareInfoRoute);
...
#[async_trait]
impl NativeMessagingRoute for CheckModelFeasibilityRoute {
    ...
    {
        let request_id = Uuid::new_v4();
        tracing::info!(request_id = %request_id, model_size = req.model_size_mb, "Check model feasibility");
...
crate::enforce_native_messaging_route!(CheckModelFeasibilityRoute);
...
#[async_trait]
impl NativeMessagingRoute for GetRecommendedModelsRoute {
...
crate::enforce_native_messaging_route!(GetRecommendedModelsRoute);
